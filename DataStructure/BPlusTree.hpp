 ...
 */
template <class Key,class Data,int M = 300,int L = 150,int C = 131>
class BPlusTree{
private:
    class basicInfo{
    public:
...
public:
    ...
    BPlusTree() = delete;
    explicit BPlusTree(const string & _name):leafDisk(_name + "_leaf.dat",C),nodeDisk(_name + "_node.dat",151){
